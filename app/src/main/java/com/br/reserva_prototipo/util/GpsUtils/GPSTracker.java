...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                Log.d(TAG, "Nenhum provedor de GPS disponível");
            } else {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setMessage("GPS não está ativo. É necessário a ativação do GPS para você obter uma melhor experiência!");
